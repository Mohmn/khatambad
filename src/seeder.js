...
const pool = new Pool({
  connectionString:
    "postgresql://Mohmn:o7el5hzJNgIE@ep-lucky-dew-94214037.ap-southeast-1.aws.neon.tech/neondb?sslmode=require",
});
async function insertCategory(name) {
  const text =
    'INSERT INTO "public"."Category"(name) VALUES($1) ON CONFLICT (name) DO NOTHING';
  const values = [name];
